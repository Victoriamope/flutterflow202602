...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/SPLASH_SABOR_LOCAL.png',
                  fit: BoxFit.cover,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
          name: CadastroCEPWidget.routeName,
          path: CadastroCEPWidget.routePath,
          builder: (context, params) => CadastroCEPWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ParticipantesWidget.routeName,
          path: ParticipantesWidget.routePath,
          builder: (context, params) => ParticipantesWidget(),
        )

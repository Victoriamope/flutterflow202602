...
import 'cadastro_c_e_p_model.dart';
export 'cadastro_c_e_p_model.dart';

class CadastroCEPWidget extends StatefulWidget {
  const CadastroCEPWidget({super.key});

  static String routeName = 'CadastroCEP';
  static String routePath = '/cadastroCEP';

  @override
  State<CadastroCEPWidget> createState() => _CadastroCEPWidgetState();
}

class _CadastroCEPWidgetState extends State<CadastroCEPWidget> {
  late CadastroCEPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroCEPModel());
    ...
    _model.textFieldReferenciaTextController ??= TextEditingController();
    _model.textFieldReferenciaFocusNode ??= FocusNode();
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFFFCF3DC),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                30.0, 0.0, 30.0, 0.0),
                            child: Text(
                              'Cadastre seu primeiro endereço aqui. Caso você\nqueira cadastrar mais endereços, você poderá \nfazê-lo posteriormente.',
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (_) => EasyDebounce.debounce(
                            ...
                            () async {
                              ...
                              _model.apiResultm5v = await BuscaCEPCall.call(
                                cep: _model.textFieldCEPTextController.text,
                              );

                              safeSetState(() {
                                _model.textFieldLogradouroTextController?.text =
                                    BuscaCEPCall.rua(
                                  (_model.apiResultm5v?.jsonBody ?? ''),
                                )!;
                              });
                              safeSetState(() {
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.textFieldLogradouroTextController,
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        width: double.infinity,
                        child: TextFormField(
                          controller: _model.textFieldReferenciaTextController,
                          focusNode: _model.textFieldReferenciaFocusNode,
                          autofocus: false,
                          enabled: true,
                          obscureText: false,
                          decoration: InputDecoration(
